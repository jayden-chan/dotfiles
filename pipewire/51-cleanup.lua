local rule_scarlett_4i4_device = {
	matches = {
		...
		{ { "device.name", "equals", "alsa_card.usb-Focusrite_Scarlett_4i4_USB_D8NFB4Q1B2270D-00" } },
	},
	apply_properties = {
...
local rule_dx5_sink = {
	matches = {
		...
		{
			{ "node.name", "equals", "alsa_output.usb-Topping_DX5-00.pro-output-0" },
			{ "media.class", "equals", "Audio/Sink" },
		},
		{
			{ "node.name", "equals", "alsa_output.usb-Topping_DX5-00.1.pro-output-0" },
			{ "media.class", "equals", "Audio/Sink" },
		},
		{
			{ "node.name", "equals", "alsa_output.usb-Topping_DX5-00.2.pro-output-0" },
			{ "media.class", "equals", "Audio/Sink" },
		},
		{
			{ "node.name", "equals", "alsa_output.usb-Topping_DX5-00.3.pro-output-0" },
			{ "media.class", "equals", "Audio/Sink" },
		},
	},
	apply_properties = {
